...
qx.Class.define("myapp.pages.Login", {
  ...
  construct: function () {
    ...
    // Title
    const title = new myapp.components.ui.Label(
    ...
    // Subtitle
    const subtitle = new myapp.components.ui.Label(
    ...
    this._loginButton = new myapp.components.ui.Button(
      "Login",
      "primary",
      "sm",
    );
    ...
    // Sign up button
    this._signUpButton = new myapp.components.ui.Button(
      "Sign up",
      "secondary",
      "sm",
    );
