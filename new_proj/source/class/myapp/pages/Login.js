...
************************************************************************ */
qx.Class.define("myapp.pages.Login", {
    ...
    construct: function () {
        ...
        myapp.util.Theme.applyBackground(this, "background");
        // Center container
        ...
        myapp.util.Theme.styleContainer(centerContainer, {
            background: "card",
        ...
        // Title
        const title = new myapp.components.ui.Label("Student Registration System");
        title.setFont("bold");
        centerContainer.add(title);
        // Subtitle
        const subtitle = new myapp.components.ui.Label("Please login to continue");
        ...
        const usernameLabel = new myapp.components.ui.Label("Username:");
        usernameLabel.setWidth(100); // Fixed width for alignment
        this._usernameField = new myapp.components.ui.TextField();
        ...
        const passwordLabel = new myapp.components.ui.Label("Password:");
        passwordLabel.setWidth(100); // Fixed width for alignment
        this._passwordField = new myapp.components.ui.PasswordField();
        ...
        // Error message label
        this._errorLabel = new myapp.components.ui.Label("");
        ...
        this._loginButton = new myapp.components.ui.Button("Login", "primary", "sm");
        ...
        this._loginButton.addListener("execute", () => {
            this._handleLogin();
        }, this);
        // Sign up button
        this._signUpButton = new myapp.components.ui.Button("Sign up", "secondary", "sm");
        ...
        this._signUpButton.addListener("execute", () => {
    ...
    members: {
        ...
        _openRegistrationWindow: function () {
            ...
            this._registrationWindow = new myapp.components.Windows.RegistrationWindow();
            ...
            this._registrationWindow.addListener("registrationSuccess", (e) => {
                ...
                this.clear();
                const primaryColor = myapp.util.Theme.getCSSVariable("primary");
        ...
        _showError: function (message) {
            ...
            if (message.includes('<span')) {
                ...
                const destructiveColor = myapp.util.Theme.getCSSVariable("destructive");
