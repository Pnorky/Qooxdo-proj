...
************************************************************************ */
qx.Class.define("myapp.components.Windows.StudentInfoTableWindow", {
    ...
    construct: function () {
        ...
        this._studentInfoTable = new myapp.components.Tabs.StudentInfoTable();
    ...
    members: {
         ...
         * @return {myapp.components.Tabs.StudentInfoTable} The student info table component
         */
