...
************************************************************************ */
qx.Class.define("myapp.components.Windows.PersonalInfoWindow", {
    ...
    construct: function () {
        ...
        this._personalInfoTab = new myapp.components.Tabs.PersonalInfoTab();
    ...
    members: {
         ...
         * @return {myapp.components.Tabs.PersonalInfoTab} The personal info tab component
         */
