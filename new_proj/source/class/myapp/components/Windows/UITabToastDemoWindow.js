...
************************************************************************ */
qx.Class.define("myapp.components.Windows.UITabToastDemoWindow", {
    ...
    construct: function () {
        ...
        this._demoTab = new myapp.components.Tabs.UITabToastSampleTab();
    ...
    members: {
         ...
         * @return {myapp.components.Tabs.UITabToastSampleTab|null}
         */
        getDemoTab: function () {
