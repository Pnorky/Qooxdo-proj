...
qx.Class.define("myapp.components.Windows.AcademicInfoWindow",
{
  ...
  construct : function()
  {
    ...
    this._academicInfoTab = new myapp.components.Tabs.AcademicInfoTab();
  ...
  members :
  {
     ...
     * @return {myapp.components.Tabs.AcademicInfoTab} The academic info tab component
     */
