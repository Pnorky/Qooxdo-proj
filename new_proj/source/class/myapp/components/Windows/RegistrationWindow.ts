...
qx.Class.define("myapp.components.Windows.RegistrationWindow", {
  ...
  construct: function () {
    ...
    const card = new myapp.components.ui.Card("Create New Account", "");
    ...
    this._termsCheckbox = new myapp.components.ui.CheckBox("I agree to the terms and conditions");
    ...
    // Register button
    this._registerButton = new myapp.components.ui.Button(
      "Register",
      "primary",
      "sm",
    );
    ...
    // Cancel button
    this._cancelButton = new myapp.components.ui.Button(
      "Cancel",
      "secondary",
      "sm",
    );
