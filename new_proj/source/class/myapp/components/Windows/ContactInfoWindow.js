...
************************************************************************ */
qx.Class.define("myapp.components.Windows.ContactInfoWindow", {
    ...
    construct: function () {
        ...
        this._contactInfoTab = new myapp.components.Tabs.ContactInfoTab();
    ...
    members: {
         ...
         * @return {myapp.components.Tabs.ContactInfoTab} The contact info tab component
         */
