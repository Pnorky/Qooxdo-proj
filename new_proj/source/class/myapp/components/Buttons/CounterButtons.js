...
************************************************************************ */
qx.Class.define("myapp.components.Buttons.CounterButtons", {
    ...
    members: {
        ...
        _createButtons: function () {
            ...
            this._pressMeButton = new myapp.components.ui.Button("Press Me", "primary", "sm");
            // this._resetCounterButton = new qx.ui.form.Button("Reset Counter");
            this._resetCounterButton = new myapp.components.ui.Button("Reset", "secondary", "sm");
