 ...
 * Also supports qooxdoo-like pages: add(new myapp.components.ui.TabPage(...)).
 */
qx.Class.define("myapp.components.ui.TabView", {
    ...
    members: {
        ...
        _unbindPageListeners(tab) {
            if (!tab || !tab.page || !tab._pageListenerIds)
                return;
      ...
      `;
         ...
         * - add(page: myapp.components.ui.TabPage)
         * - add(label: String, content: String)
         * @param {myapp.components.ui.TabPage|String} pageOrLabel
         * @param {String?} content
         * @return {Number} New tab index
         */
        add(pageOrLabel, content = "") {
            if (pageOrLabel instanceof myapp.components.ui.TabPage) {
         ...
         * @param {myapp.components.ui.TabPage} page
         * @return {Number} New tab index
         */
        addPage(page) {
            if (!(page instanceof myapp.components.ui.TabPage)) {
                return -1;
            }
         ...
         * - remove(index: Number)
         * - remove(page: myapp.components.ui.TabPage)
         * @param {Number|myapp.components.ui.TabPage} pageOrIndex
         */
        remove(pageOrIndex) {
            ...
            if (pageOrIndex instanceof myapp.components.ui.TabPage) {
         ...
         * @return {myapp.components.ui.TabPage[]}
         */
        getPages() {
