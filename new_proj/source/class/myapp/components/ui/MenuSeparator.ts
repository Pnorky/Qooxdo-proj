...
qx.Class.define("myapp.components.ui.MenuSeparator", {
  ...
  construct: function () {
    ...
    this.addListener("changeVisibility", (e: any) => {
  ...
  members: {
    _applyStyles: function (): void {
      const contentElement = this.getContentElement ? this.getContentElement() : null;
      const element = contentElement ? (contentElement.getDomElement() as HTMLElement | null) : null;
      if (!element) return;
