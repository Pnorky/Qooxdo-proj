qx.Class.define("myapp.components.ui.Button", {
    ...
    members: {
         ...
         * @return {myapp.components.ui.Button} this
         */
        setBasecoatToolTip(text, side = "top", align = "center") {
            if (!this._basecoatToolTip) {
                this._basecoatToolTip = new myapp.components.ui.ToolTip(String(text || ""), side || "top", align || "center");
         ...
         * @return {myapp.components.ui.ToolTip|null}
         */
        getBasecoatToolTip() {
