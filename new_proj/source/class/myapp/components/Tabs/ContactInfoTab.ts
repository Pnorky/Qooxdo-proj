...
qx.Class.define("myapp.components.Tabs.ContactInfoTab",
{
  ...
  members :
  {
    ...
    _createForm : function()
    {
      ...
      // Contact Info Fields
      this._emailField = new myapp.components.ui.TextField();
      const emailLabel = new myapp.components.ui.Label("Email:");
      grid.add(emailLabel, { row: 0, column: 0 });
      grid.add(this._emailField, { row: 0, column: 1 });

      this._personalPhoneField = new myapp.components.ui.TextField();
      const personalPhoneLabel = new myapp.components.ui.Label("Personal Phone:");
      ...
      this._emergencyContactField = new myapp.components.ui.TextField();
      const emergencyContactLabel = new myapp.components.ui.Label("Emergency Contact:");
      ...
      this._emergencyContactPhoneField = new myapp.components.ui.TextField();
      const emergencyContactPhoneLabel = new myapp.components.ui.Label("Emergency Contact Phone:");
      ...
      this._relationshipField = new myapp.components.ui.TextField();
      const relationshipLabel = new myapp.components.ui.Label("Relationship:");
