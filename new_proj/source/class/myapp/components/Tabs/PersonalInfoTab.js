...
************************************************************************ */
qx.Class.define("myapp.components.Tabs.PersonalInfoTab", {
    ...
    members: {
        ...
        _createForm: function () {
            ...
            this._studentIdField = new myapp.components.ui.TextField();
            grid.add(new myapp.components.ui.Label("Student ID:"), {
                row: 0,
                column: 0,
            });
            grid.add(this._studentIdField, { row: 0, column: 1 });
            this._firstNameField = new myapp.components.ui.TextField();
            grid.add(new myapp.components.ui.Label("First Name:"), { row: 1, column: 0 });
            grid.add(this._firstNameField, { row: 1, column: 1 });
            this._lastNameField = new myapp.components.ui.TextField();
            grid.add(new myapp.components.ui.Label("Last Name:"), { row: 2, column: 0 });
            grid.add(this._lastNameField, { row: 2, column: 1 });
            this._dobField = new myapp.components.ui.DateField();
            this._dobField.setMaxWidth(180);
            grid.add(new myapp.components.ui.Label("Date of Birth:"), { row: 3, column: 0 });
            grid.add(this._dobField, { row: 3, column: 1 });
            this._genderField = new myapp.components.ui.ComboBox();
            ...
            const genderLabel = new myapp.components.ui.Label("Gender:");
            ...
            const addressLabel = new myapp.components.ui.Label("Address:");
            ...
            this._addressField = new myapp.components.ui.TextArea();
        ...
        getData: function () {
            return {
                ...
                gender: this._genderField.getSelection() &&
        ...
        validate: function () {
            if (!this._studentIdField.getValue() ||
                ...
                return {
                    valid: false,
                    message: "Please fill required Personal Info fields (Student ID, First Name, Last Name)",
                };
            }
            return { valid: true };
        },
