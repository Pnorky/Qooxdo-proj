...
************************************************************************ */
qx.Class.define("myapp.components.Tabs.StudentInfoTable", {
    ...
    members: {
        ...
        _createTable: function () {
            ...
            this._table = new myapp.components.ui.Table("");
            // Set table headers
        ...
        _createWindows: function () {
            ...
            this._editWindow = new myapp.components.ui.Dialog("Edit Student", "Update student information below.");
            ...
            this._deleteWindow = new myapp.components.ui.Dialog("Delete Student", "Please review the details before continuing.");
        ...
        _ensureFeedbackUI: function () {
            ...
            if (!this._feedbackDialog) {
                this._feedbackDialog = new myapp.components.ui.Dialog("Action failed", "");
        ...
        _deleteStudent: function (studentId) {
            if (!myapp.Config.USE_API) {
                this._studentsData = (this._studentsData || []).filter((s) => String(s.id) !== String(studentId));
                this._rebuildTableFromStudentsData();
                this._ensureFeedbackUI();
                if (this._feedbackToast) {
                    this._feedbackToast.show({
