...
************************************************************************ */
qx.Class.define("myapp.components.Tabs.UISampleTab", {
    ...
    construct: function () {
        ...
        const accordion = new myapp.components.ui.Accordion();
        accordion.setItems([
        ...
        const card = new myapp.components.ui.Card("Sample Card", "A subtitle for the card");
        card.getSection().add(new myapp.components.ui.Label("Card body content goes here."));
        wrapper.add(card);
        // CheckBox demo
        addSectionTitle("CheckBox");
        const checkbox = new myapp.components.ui.CheckBox("I'm a custom checkbox");
        ...
        const dialog = new myapp.components.ui.Dialog("Demo Dialog", "This dialog was opened from the UI demo tab.");
        dialog.setSectionContent("Dialog body content can be plain text or HTML.");
        const dialogStatus = new myapp.components.ui.Label("Dialog status: idle");
        ...
        wrapper.add(dialog);
        const showDialogBtn = new myapp.components.ui.Button("Show Dialog", "primary", "sm");
        ...
        const popover = new myapp.components.ui.Popover("Help", "Popover Title", "Short description");
