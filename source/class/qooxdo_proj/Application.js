    ...
    members: {
        ...
        _initializeMainApplication() {
            ...
            const syncSidebarAndNavbarLayout = () => {
                ...
                const isMainScreenVisible = !!this._mainContainer && this._mainContainer.getVisibility && this._mainContainer.getVisibility() === "visible";
                ...
                if (isMobile) {
                    ...
                    if (this._buttonContainer) {
                        ...
                        if (this._buttonContainer.isVisible && this._buttonContainer.isVisible()) {
                            this._buttonContainer.setVisibility(isMainScreenVisible && !this._mobileSidebarOpen ? "visible" : "excluded");
                        }
                    }
            ...
            this._windowManager.registerWindow("personalInfo", this._personalInfoWindow, { left: 50, top: 80, open: false });
            this._windowManager.registerWindow("contactInfo", this._contactInfoWindow, { left: 680, top: 80, open: false });
            this._windowManager.registerWindow("academicInfo", this._academicInfoWindow, { left: 1310, top: 80, open: false });
            this._windowManager.registerWindow("studentTable", this._studentInfoTableWindow, { left: 50, top: 600, open: false, });
            // UI demo window (shows examples of the custom components)
            this._uiDemoWindow = new qooxdo_proj.components.Windows.UIDemoWindow();
            this._windowManager.registerWindow("uiDemo", this._uiDemoWindow, { left: 700, top: 600, open: false });
            // Separate demo window for TabView + Toast
            this._uiTabToastDemoWindow = new qooxdo_proj.components.Windows.UITabToastDemoWindow();
            this._windowManager.registerWindow("uiTabToastDemo", this._uiTabToastDemoWindow, { left: 1380, top: 600, open: false });
