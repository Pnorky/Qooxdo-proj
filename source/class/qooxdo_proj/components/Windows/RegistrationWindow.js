...
qx.Class.define("qooxdo_proj.components.Windows.RegistrationWindow", {
    ...
    construct: function () {
        ...
        // Register button
        this._registerButton = new qooxdo_proj.components.ui.Button("Register", "primary", "sm");
        // Cancel button
        this._cancelButton = new qooxdo_proj.components.ui.Button("Cancel", "secondary", "sm");
