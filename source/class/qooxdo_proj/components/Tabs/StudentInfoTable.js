...
qx.Class.define("qooxdo_proj.components.Tabs.StudentInfoTable", {
    ...
    members: {
        ...
        _createWindows: function () {
            ...
            this._editWindow = new qooxdo_proj.components.ui.Dialog("Edit Student", "Update student information below.");
            ...
            this._deleteWindow = new qooxdo_proj.components.ui.Dialog("Delete Student", "Please review the details before continuing.");
