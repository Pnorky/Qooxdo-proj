...
qx.Class.define("qooxdo_proj.pages.Login",
{
  ...
  construct : function()
  {
    ...
    centerContainer.setWidth(320);
    centerContainer.setMinWidth(320);
    centerContainer.setMaxWidth(320);
    
    // Title
    const title = new qx.ui.basic.Label("Student Registration System");
    title.setFont("bold");
    centerContainer.add(title);
    
    // Subtitle
    const subtitle = new qx.ui.basic.Label("Please login to continue");
    ...
    centerContainer.add(this._usernameField);
    ...
    centerContainer.add(this._passwordField);
