...
qx.Class.define("qooxdo_proj.pages.Login", {
    ...
    construct: function () {
        ...
        // Title
        const title = new qooxdo_proj.components.ui.Label("Student Registration System");
        title.setFont("bold");
        centerContainer.add(title);
        // Subtitle
        const subtitle = new qooxdo_proj.components.ui.Label("Please login to continue");
        ...
        this._loginButton = new qooxdo_proj.components.ui.Button("Login", "primary", "sm");
        ...
        // Sign up button
        this._signUpButton = new qooxdo_proj.components.ui.Button("Sign up", "secondary", "sm");
